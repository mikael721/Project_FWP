...
(async () => {
  try {
    ...
    await connectMongoDB(); // atau seedDatabase()
    await initDatabase();
...
const seedDatabase = async () => {
  console.log("🌱 Seeding MongoDB from MySQL data...");
  ...
  console.log("✅ Seeder selesai & database konsisten");
};
...
const initDatabase = async () => {
  ...
  if (menuCount === 0) {
    console.log("📦 Database kosong → jalankan seeder");
    await seedDatabase();
  } else {
    console.log("✅ Database sudah terisi → skip seeder");
  }
};
